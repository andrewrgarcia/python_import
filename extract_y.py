...
ap.add_argument("-p", "--path", 
                default = r'C:\Users\garci\...\folder/', type = str, 
                help="path to csv files")
ap.add_argument("-r", "--reference_column", 
                default = "Wavelength", type = str, 
                help="name of reference column for indexing")
ap.add_argument("-i", "--indexed_column", 
                default = "Abs", type = str, 
                help="name of column which is indexed based on reference column")
ap.add_argument("-c", "--string_cutoff", 
                default = "M",type = str,
                help="if file name contains the x-value up to a certain string character\
...
ap.add_argument("-l", "--lookup_value", 
                ...
                help="lookup value for reference column")
